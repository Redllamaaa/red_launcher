...
//#region node_modules/.pnpm/toml@5.0.0/node_modules/toml/lib/parser.js
var require_parser = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	function peg$parse(input, options) {
		...
		function peg$f8(node) {
			return node.value;
		}
		function peg$f9(node) {
			return node.value;
		}
		function peg$f10() {
			if (++depth > MAX_DEPTH) {
		...
		function peg$f36(text) {
			return node("Float", parseFloat(stripUnderscores(text)), offset());
		}
		...
		function peg$f45(text) {
			return node("Integer", BigInt(stripUnderscores(text)), offset());
		}
		...
		function peg$parsenumber_or_date() {
			...
			if (s0 === peg$FAILED) {
				...
				if (s0 === peg$FAILED) {
					...
					if (s0 === peg$FAILED) {
						s0 = peg$parsefloat();
						if (s0 === peg$FAILED) s0 = peg$parseinteger();
					}
				}
			}
			return s0;
		...
		function peg$parseDEC_INT_NOZERO_SEQ() {
			...
			if (s1 !== peg$FAILED) {
				...
				if (peg$r10.test(s5)) peg$currPos++;
				else {
					s5 = peg$FAILED;
		...
		function peg$parseDEC_DIGIT_SEQ() {
			...
			s0 = peg$currPos;
			s1 = input.charAt(peg$currPos);
			if (peg$r10.test(s1)) peg$currPos++;
			else {
				s1 = peg$FAILED;
				if (peg$silentFails === 0) peg$fail(peg$e30);
			}
		...
		function peg$parseHEX_DIGIT_SEQ() {
			...
			s0 = peg$currPos;
			s1 = input.charAt(peg$currPos);
			if (peg$r11.test(s1)) peg$currPos++;
			else {
				s1 = peg$FAILED;
			...
			if (s1 !== peg$FAILED) {
				...
				if (s4 === peg$FAILED) s4 = null;
				s5 = input.charAt(peg$currPos);
				if (peg$r11.test(s5)) peg$currPos++;
				else {
					s5 = peg$FAILED;
					if (peg$silentFails === 0) peg$fail(peg$e31);
				}
		...
		function peg$parseOCT_DIGIT_SEQ() {
			...
			s0 = peg$currPos;
			s1 = input.charAt(peg$currPos);
			if (peg$r12.test(s1)) peg$currPos++;
			else {
				s1 = peg$FAILED;
			...
			if (s1 !== peg$FAILED) {
				...
				if (s4 === peg$FAILED) s4 = null;
				s5 = input.charAt(peg$currPos);
				if (peg$r12.test(s5)) peg$currPos++;
				else {
					s5 = peg$FAILED;
					if (peg$silentFails === 0) peg$fail(peg$e32);
				}
		...
		function peg$parseBIN_DIGIT_SEQ() {
			...
			s0 = peg$currPos;
			s1 = input.charAt(peg$currPos);
			if (peg$r13.test(s1)) peg$currPos++;
			else {
				s1 = peg$FAILED;
			...
			if (s1 !== peg$FAILED) {
				...
				if (s4 === peg$FAILED) s4 = null;
				s5 = input.charAt(peg$currPos);
				if (peg$r13.test(s5)) peg$currPos++;
				else {
					s5 = peg$FAILED;
					if (peg$silentFails === 0) peg$fail(peg$e33);
				}
		...
		function peg$parsesimple_key() {
			let s0;
			s0 = peg$parsekey();
			if (s0 === peg$FAILED) s0 = peg$parsequoted_key();
			return s0;
		}
		...
		function peg$parseoffset() {
			...
			s0 = peg$currPos;
			s1 = input.charAt(peg$currPos);
			if (s1.toLowerCase() === peg$c26) peg$currPos++;
			else {
				s1 = peg$FAILED;
		...
		function peg$parsedatetime_delim() {
			...
			if (s0.toLowerCase() === peg$c27) peg$currPos++;
			else {
				s0 = peg$FAILED;
		...
		function peg$parseS() {
			let s0;
			s0 = input.charAt(peg$currPos);
			if (peg$r14.test(s0)) peg$currPos++;
			else {
				s0 = peg$FAILED;
		...
		function peg$parseDIGIT() {
			let s0;
			s0 = input.charAt(peg$currPos);
			if (peg$r10.test(s0)) peg$currPos++;
			else {
				s0 = peg$FAILED;
				if (peg$silentFails === 0) peg$fail(peg$e30);
			}
		...
		function peg$parseHEX() {
			let s0;
			s0 = input.charAt(peg$currPos);
			if (peg$r11.test(s0)) peg$currPos++;
			else {
				s0 = peg$FAILED;
				if (peg$silentFails === 0) peg$fail(peg$e31);
			}
		...
		function peg$parseASCII_BASIC() {
			let s0;
			s0 = input.charAt(peg$currPos);
			if (peg$r15.test(s0)) peg$currPos++;
			else {
				s0 = peg$FAILED;
		...
		function peg$parseESCAPED() {
			...
			if (s1 !== peg$FAILED) {
				s2 = input.charAt(peg$currPos);
				if (peg$r16.test(s2)) peg$currPos++;
				else {
					s2 = peg$FAILED;
		...
		function resolveLineCol(off) {
			var line = 1, col = 1;
			for (var i = 0; i < off; i++) if (inputText.charCodeAt(i) === 10) {
				line++;
				col = 1;
			} else col++;
			return {
		...
		function validateDate(dateStr, off) {
			...
			if (month < 1 || month > 12) genError("Invalid date: month " + month + " out of range.", off);
			var maxDays = [
				31,
				28,
				31,
			...
			if (year % 4 === 0 && year % 100 !== 0 || year % 400 === 0) maxDays[1] = 29;
			if (day < 1 || day > maxDays[month - 1]) genError("Invalid date: day " + day + " out of range for month " + month + ".", off);
		}
		function validateTime(timeStr, off) {
			...
			if (hour > 23) genError("Invalid time: hour " + hour + " out of range.", off);
			if (minute > 59) genError("Invalid time: minute " + minute + " out of range.", off);
			if (second > 59) genError("Invalid time: second " + second + " out of range.", off);
		}
		function validateOffset(offsetStr, off) {
			...
			if (hour > 23) genError("Invalid offset: hour " + hour + " out of range.", off);
			if (minute > 59) genError("Invalid offset: minute " + minute + " out of range.", off);
		}
		...
		function convertCodePoint(str) {
			...
			if (num !== num || num < 0 || num > 1114111 || num > 55295 && num < 57344) genError("Invalid Unicode escape code: " + str, offset());
			else return String.fromCodePoint(num);
		}
...
//#endregion
//#region node_modules/.pnpm/toml@5.0.0/node_modules/toml/lib/compiler.js
var require_compiler = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	function compile(nodes, inputText, options) {
		...
		if (options.useTemporal) {
			...
			if (!temporal) throw new Error("The `useTemporal` option was set, but no Temporal implementation is available. Use a runtime with global `Temporal` support, or provide an implementation (e.g. from the `@js-temporal/polyfill` package) via the `temporal` option.");
		}
			...
			for (var i = 0; i < nodes.length; i++) {
				...
				switch (node.type) {
					...
					case "ObjectPath":
						setPath(node);
						break;
					case "ArrayPath": addTableArray(node);
				}
			}
			return data;
		}
		...
		function assign(node) {
			...
			for (var i = 0; i < keys.length - 1; i++) {
				...
				} else if (typeof target[k] !== "object" || target[k] === null || Array.isArray(target[k])) genError("Cannot redefine existing key '" + intermediatePath + "'.", off);
				else if (valueAssignments.has(intermediatePath)) genError("Cannot redefine existing key '" + intermediatePath + "'.", off);
				else if (explicitTablePaths.has(intermediatePath) && intermediatePath !== pathKey(currentPath)) genError("Cannot use dotted keys to extend table '" + intermediatePath + "' defined elsewhere.", off);
				target = target[k];
			}
			var lastKey = keys[keys.length - 1];
			var fullPath = makeFullPath(keys);
			if (typeof target[lastKey] !== "undefined") genError("Cannot redefine existing key '" + fullPath + "'.", off);
			target[lastKey] = reduced;
			assignedPaths.add(fullPath);
			valueAssignments.add(fullPath);
		}
		function reduceValueNode(node) {
			if (node.type === "Integer") return reduceInteger(node);
			else if (node.type === "Array") return reduceArray(node.value);
			else if (node.type === "InlineTable") return reduceInlineTableNode(node.value);
			else if (temporal) switch (node.type) {
				case "Date": return temporal.ZonedDateTime.from(truncateFractionalSeconds(node.raw) + node.tz + "[" + (node.tz === "Z" ? "UTC" : node.tz) + "]");
				case "LocalDateTime": return temporal.PlainDateTime.from(truncateFractionalSeconds(node.value));
				case "LocalDate": return temporal.PlainDate.from(node.value);
				case "LocalTime": return temporal.PlainTime.from(truncateFractionalSeconds(node.value));
			}
			return node.value;
		}
		...
		function reduceInteger(node) {
			var value = node.value;
			if (value < INT64_MIN || value > INT64_MAX) genError("Integer " + value + " is outside the 64-bit signed integer range required by TOML.", node.offset);
			if (options.bigint) return value;
			if (value < MIN_SAFE || value > MAX_SAFE) genError("Integer " + value + " cannot be represented losslessly as a JavaScript number. Use the `bigint` option to parse integers as BigInt values.", node.offset);
			return Number(value);
		}
		...
		function setNestedKey(obj, keys, value, off, definedKeys) {
			for (var i = 0; i < keys.length - 1; i++) {
				...
				if (typeof obj[k] === "undefined") obj[k] = createTable();
				else if (typeof obj[k] !== "object" || obj[k] === null || Array.isArray(obj[k])) genError("Cannot redefine existing key '" + intermediatePath + "'.", off);
				else if (definedKeys && definedKeys.has(intermediatePath)) genError("Cannot extend inline table '" + intermediatePath + "'.", off);
				obj = obj[k];
			}
			var lastKey = keys[keys.length - 1];
			if (typeof obj[lastKey] !== "undefined") genError("Cannot redefine existing key '" + pathKey(keys) + "'.", off);
			obj[lastKey] = value;
		}
		function setPath(node) {
			...
			var off = node.offset;
			if (assignedPaths.has(quotedPath)) genError("Cannot redefine existing key '" + path + "'.", off);
		...
		function addTableArray(node) {
			...
			var quotedPath = path.map(quoteDottedString).join(".");
			var off = node.offset;
			if (valueAssignments.has(quotedPath)) genError("Cannot append to statically defined array '" + quotedPath + "'.", off);
			...
			if (context instanceof Array) {
				...
				context.push(newObj);
				context = newObj;
			} else genError("Cannot redefine existing key '" + path + "'.", off);
		}
		function deepRef(start, keys, value, off) {
			...
			for (var i = 0; i < keys.length; i++) {
				...
				if (typeof ctx[key] === "undefined") {
					...
					else ctx[key] = createTable();
				} else if (i !== keys.length - 1 && valueAssignments.has(traversedPath)) genError("Cannot redefine existing key '" + traversedPath + "'.", off);
				ctx = ctx[key];
				if (i < keys.length - 1) {
					if (!isOwnedContainer(ctx)) genError("Cannot redefine existing key '" + traversedPath + "'.", off);
					if (ctx instanceof Array) {
						if (!ctx.length) genError("Cannot redefine existing key '" + traversedPath + "'.", off);
...
//#endregion
//#region node_modules/.pnpm/toml@5.0.0/node_modules/toml/index.js
